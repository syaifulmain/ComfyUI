...
def cast_bias_weight(s, input=None, dtype=None, device=None, bias_dtype=None):
    ...
    bias = None
    non_blocking = com.model_management.device_supports_non_blocking(device)
...
def fp8_linear(self, input):
    ...
    if len(input.shape) == 3:
        ...
        non_blocking = com.model_management.device_supports_non_blocking(input.device)
...
def pick_operations(weight_dtype, compute_dtype, load_device=None):
    ...
    if args.fast:
        if com.model_management.supports_fp8_compute(load_device):
            return fp8_ops
    return manual_cast
